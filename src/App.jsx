    ...
    <PhotographyProvider>
      <Router>
        <div className="bg-silk min-h-screen text-wood selection:bg-cashmere selection:text-wood">
          ...
          <div className="fixed top-0 left-0 w-32 h-32 border-t-2 border-l-2 border-wood/5 m-8 pointer-events-none" />
          <div className="fixed bottom-0 right-0 w-32 h-32 border-b-2 border-r-2 border-wood/5 m-8 pointer-events-none" />
        </div>
      </Router>
    </PhotographyProvider>
  );
